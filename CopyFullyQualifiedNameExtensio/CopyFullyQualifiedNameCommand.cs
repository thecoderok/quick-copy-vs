...
namespace VitaliiGanzha.VisualStudio.CopyFullyQualifiedNameExtension
{
    ...
    internal sealed class CopyFullyQualifiedNameCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("462bff2d-5a7d-405f-a528-d0203558c182");
        ...
        {
            CopyFullyQualifiedNamePackage instance = new CopyFullyQualifiedNamePackage();
            instance.RunShit();
        }
    }
}
